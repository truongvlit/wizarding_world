            ...
            <div class="row h-100 justify-content-center align-items-center">
                <form action="register" method="POST" class="col-4">
                    ...
                    <div class="form-group mb-5 text-center h1">
                        Register New<br/>Wizarding Passport
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group text-center w-50 m-auto">
                            <input type="submit" value="Register" class="btn btn-info rounded-button form-control h-50-px"/>
                        </div>
                    </div>
                </form>
                <div class="w-100 justify-content-center align-items-center text-center mt--50px">
                    <a href="init-login" class="text-decoration-none">Back to Login Page</a>
                </div>
            </div>
        </div>
    </body>
